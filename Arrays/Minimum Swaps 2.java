...
class Solution {
    public int solve(ArrayList<Integer> A) {
        ...
        //iterate the array and sort and count swap
        for(int i=0; i<N; i++){

            //have to swap until A[i] = i, and count number of swaps
            while(A.get(i) != i){
...
/*
T.C = O(N) ---->T.C = Total number of swaps(At each swap we are correcting atleast 1 index, at max 
there are N index, therefore max no. of swaps possible = N)
S.C = O(1)
*/